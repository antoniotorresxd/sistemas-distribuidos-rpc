...
El instructivo propone desplegar la arquitectura completa orquestada con \texttt{docker compose}, registrar métricas con Prometheus y exponerlas en Grafana. Ambos elementos se implementaron.
